...
public class MainActivity extends AppCompatActivity {
    ...
    RecyclerView r2;
    String[] bs1,bs2,bs3;
    int imageResource[] = {R.drawable.bedroom,R.drawable.bedroom,R.drawable.bedroom};
    int imgresource[]={
            R.drawable.bedroom,R.drawable.bedroom,R.drawable.bedroom};
    int imgres[]= {R.drawable.bedroom, R.drawable.bedroom, R.drawable.bedroom};


    int boardimage[]={R.drawable.bedroom,R.drawable.bedroom,R.drawable.bedroom};
    int boardimg[]={R.drawable.bedroom,R.drawable.bedroom,R.drawable.bedroom};
    int boardimgres[]={R.drawable.bedroom,R.drawable.bedroom,R.drawable.bedroom};


    selectroomAdapter ad;
    BoardAdapter ad1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        r1=(RecyclerView)findViewById(R.id.room);
        s1=getResources().getStringArray(R.array.room1);
        s2=getResources().getStringArray(R.array.room2);
        s3=getResources().getStringArray(R.array.room3);

        ad=new selectroomAdapter(this,s1,s2,s3,imageResource,imgresource,imgres);

        r1.setAdapter(ad);
        r1.setLayoutManager(new LinearLayoutManager(this));


       r2=(RecyclerView)findViewById(R.id.board);
        bs1=getResources().getStringArray(R.array.board1);
        bs2=getResources().getStringArray(R.array.board2);
        bs3=getResources().getStringArray(R.array.board3);

        ad=new selectroomAdapter(this,bs1,bs2,bs3,boardimage,boardimg,boardimgres);
